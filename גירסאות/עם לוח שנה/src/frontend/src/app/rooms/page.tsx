...
export default function RoomsPage() {
  ...
  const handleAddRoom = () => {
      ...
      <div class="bg-white p-6 rounded-lg shadow-xl max-w-2xl w-full max-h-screen overflow-y-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="mb-4">
            ...
            <input type="text" id="roomNumber" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="׳”׳›׳ ׳¡ ׳׳¡׳₪׳¨ ׳—׳“׳¨">
            <p class="text-xs text-gray-500 mt-1">׳”׳§׳•׳׳” ׳•׳”׳׳’׳£ ׳™׳™׳§׳‘׳¢׳• ׳׳•׳˜׳•׳׳˜׳™׳× ׳׳₪׳™ ׳׳¡׳₪׳¨ ׳”׳—׳“׳¨</p>
          </div>
          
          <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700 mb-1">׳×׳›׳•׳׳× ׳—׳“׳¨:</label>
            <input type="number" id="capacity" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="׳”׳›׳ ׳¡ ׳×׳›׳•׳׳× ׳—׳“׳¨">
          </div>
          
          <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700 mb-1">׳§׳•׳׳”:</label>
            <input type="number" id="floor" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="׳”׳›׳ ׳¡ ׳׳¡׳₪׳¨ ׳§׳•׳׳”" value="1">
            <p class="text-xs text-gray-500 mt-1">׳™׳™׳§׳‘׳¢ ׳׳•׳˜׳•׳׳˜׳™׳× ׳׳₪׳™ ׳׳¡׳₪׳¨ ׳”׳—׳“׳¨</p>
          </div>
        ...
        <div class="mb-4">
          ...
          <select id="roomType" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <option value="MAMAD">׳—׳“׳¨ ׳׳"׳“</option>
            <option value="MUSIC">׳—׳“׳¨ ׳׳•׳–׳™׳§׳”</option>
            <option value="LIBRARY">׳¡׳₪׳¨׳™׳™׳”</option>
            <option value="AUDITORIUM">׳׳•׳“׳™׳˜׳•׳¨׳™׳•׳</option>
            <option value="CARAVAN">׳§׳¨׳׳•׳•׳</option>
            <option value="COORDINATOR">׳—׳“׳¨ ׳¨׳›׳–</option>
            <option value="CLASSROOM_A">׳›׳™׳×׳” ׳'</option>
            <option value="CLASSROOM_B">׳›׳™׳×׳” ׳‘'</option>
            <option value="CLASSROOM_C">׳›׳™׳×׳” ׳’'</option>
            <option value="CLASSROOM_D">׳›׳™׳×׳” ׳“'</option>
            <option value="CLASSROOM_E">׳›׳™׳×׳” ׳”'</option>
            <option value="CLASSROOM_F">׳›׳™׳×׳” ׳•'</option>
            <option value="CLASSROOM_G">׳›׳™׳×׳” ׳–'</option>
            <option value="CLASSROOM_H">׳›׳™׳×׳” ׳—'</option>
            <option value="CLASSROOM_I">׳›׳™׳×׳” ׳˜'</option>
            <option value="CLASSROOM_J">׳›׳™׳×׳” ׳™'</option>
            <option value="CLASSROOM_K">׳›׳™׳×׳” ׳™"׳</option>
            <option value="CLASSROOM_L">׳›׳™׳×׳” ׳™"׳‘</option>
            <option value="CLASSROOM_M">׳›׳™׳×׳” ׳™"׳’</option>
            <option value="CLASSROOM_N">׳›׳™׳×׳” ׳™"׳“</option>
            <option value="CLASSROOM_S">׳›׳™׳×׳” ׳¡'</option>
            <option value="CLASSROOM_EIN">׳›׳™׳×׳” ׳¢"</option>
            <option value="CLASSROOM_P">׳›׳™׳×׳” ׳₪'</option>
            <option value="CLASSROOM_TZADI">׳›׳™׳×׳” ׳¦'</option>
            <option value="CLASSROOM_KUF">׳›׳™׳×׳” ׳§'</option>
            <option value="CLASSROOM_RESH">׳›׳™׳×׳” ׳¨'</option>
            <option value="CLASSROOM_SHIN">׳›׳™׳×׳” ׳©'</option>
            <option value="CLASSROOM_TAV">׳›׳™׳×׳” ׳×'</option>
            <option value="HAGBAA">׳—׳’׳‘׳</option>
            <option value="ENGLISH_PAIRS">׳׳ ׳’׳׳™׳× ׳–׳•׳’׳•׳×</option>
            <option value="ATTIC">׳¢׳׳™׳™׳”</option>
            <option value="ALBEK">׳׳׳‘׳§</option>
          </select>
        </div>
        ...
        <div id="homeroomAssignments" class="mb-6 hidden">
          <h4 class="text-md font-semibold mb-3">׳”׳§׳¦׳׳× ׳›׳™׳×׳•׳× ׳׳</h4>
        ...
        <div class="flex justify-end space-x-2 space-x-reverse">
          <button id="cancelBtn" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 transition-colors">׳‘׳™׳˜׳•׳</button>
          <button id="addBtn" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">׳”׳•׳¡׳£ ׳—׳“׳¨</button>
        </div>
      </div>
    `;
    ...
    const createHomeroomAssignmentForm = (index: number) => {
      ...
      const fallbackGrades = [
        { id: 'a6a25529-fe66-443e-9473-3b3d5c616de3', name: '׳' },
        { id: '9e542f84-7e18-49fa-97fd-ebc8ef95ae98', name: '׳‘' },
        { id: '844fb944-baf8-4553-92cf-5c4deb0d4b52', name: '׳’' },
        { id: '14bd598c-d895-477c-a41a-486d56e586bb', name: '׳“' },
        { id: '3b39363e-6f36-44a6-9455-3dcddf6b236c', name: '׳”' },
        { id: '5082538c-ef31-47e8-b3a3-3f066e2e3f12', name: '׳•' }
      ];
  ...
  const handleEditRoom = (roomId: string) => {
    ...
    dialog.innerHTML = `
      <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full">
        <h3 class="text-lg font-bold mb-4">׳¢׳¨׳™׳›׳× ׳—׳“׳¨: ${room.room_number}</h3>
        ...
        <div class="flex justify-end space-x-2 space-x-reverse">
          <button id="cancelEditBtn" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 transition-colors">׳‘׳™׳˜׳•׳</button>
          <button id="saveEditBtn" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">׳©׳׳•׳¨</button>
        </div>
      </div>
    `;
  ...
  const getAvailabilityDisplay = (availability?: string, assignmentsCount?: number) => {
    switch (availability) {
      ...
      case 'partial':
        return { text: `׳×׳₪׳•׳¡ ׳—׳׳§׳™׳× (${assignmentsCount} ׳”׳§׳¦׳׳•׳×)`, color: 'bg-yellow-100 text-yellow-800' };
      case 'full':
            ...
            <div className="mb-8">
              <div className="bg-white shadow rounded-lg p-4 mb-4">
                <div className="flex justify-between items-center mb-4">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      {currentTime.toLocaleDateString('he-IL')} ג€¢ {currentTime.toLocaleTimeString('he-IL')}
                    </div>
                  </div>
                  <button
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  >
                    <option value="">׳›׳ ׳”׳¡׳•׳’׳™׳</option>
                    <option value="computer_lab">׳׳"׳“</option>
                    <option value="study_room">׳”׳§׳‘׳¦׳”</option>
                    <option value="ENGLISH_PAIRS">׳׳ ׳’׳׳™׳× ׳–׳•׳’׳•׳×</option>
                    <option value="music_room">׳׳•׳–׳™׳§׳”</option>
                    <option value="auditorium">׳׳•׳׳</option>
                    <option value="library">׳¡׳₪׳¨׳™׳”</option>
                  </select>
                  ...
                  >
                    ...
                    <option value="between_classes">׳‘׳™׳ ׳©׳™׳¢׳•׳¨׳™׳</option>
                  </select>
                </div>
                          ...
                          {floorRooms.map((room: RoomStatus) => (
                            ...
                            >
                              ...
                              <div className="p-1 space-y-1">
                                ...
                                {room.has_projector && (
                                  <div className="text-xs text-blue-600 text-center">נ“½</div>
                                )}
                                ...
                                {room.current_assignment && (
                                  <div className="text-xs p-1 bg-red-50 rounded border border-red-200">
                                    ...
                                    {room.current_assignment.grade && (
                                      <div className="text-red-600">׳©׳›׳‘׳” {room.current_assignment.grade}</div>
                                    )}
                                  </div>
                                )}
                                ...
                                {room.next_assignment && room.current_status !== 'occupied' && (
                                  <div className="text-xs p-1 bg-blue-50 rounded border border-blue-200">
                                    ...
                                    <div className="text-blue-600">׳-{room.next_assignment.start_time}</div>
                                  </div>
                                )}
