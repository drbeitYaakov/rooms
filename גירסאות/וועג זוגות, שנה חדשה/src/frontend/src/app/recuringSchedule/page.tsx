            ...
            <div className="mt-5 overflow-x-auto">
              <table className="min-w-full divide-y divide-slate-200 text-sm">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="px-3 py-2 text-right font-medium text-slate-600">תאריך</th>
                    <th className="px-3 py-2 text-right font-medium text-slate-600">שעה</th>
                    <th className="px-3 py-2 text-right font-medium text-slate-600">חדר</th>
                    <th className="px-3 py-2 text-right font-medium text-slate-600">מיקום</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                  {result.assignments.map((assignment) => (
                    <tr key={`${assignment.assignment_id}-${assignment.date}-${assignment.start_time}`}>
                      <td className="px-3 py-2 text-slate-800">{assignment.date}</td>
                      <td className="px-3 py-2 text-slate-700">
                        {assignment.start_time}-{assignment.end_time}
                      </td>
                      <td className="px-3 py-2 font-medium text-slate-900">{assignment.room_number}</td>
                      <td className="px-3 py-2 text-slate-700">{assignment.room_location}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
