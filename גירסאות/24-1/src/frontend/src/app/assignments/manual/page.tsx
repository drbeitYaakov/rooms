    ...
    try {
      const response = await authenticatedFetch('/api/assignments', {
        ...
        body: JSON.stringify({
          ...
          assignable_type: formData.assignable_type,
          assignable_id: formData.assignable_type === 'homeroom' ? 'homeroom' : 'manual',
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="one_on_one">פגישה אישית</option>
                    <option value="makeup_test">מבחן חוזר</option>
                    <option value="camp_prep">הכנה למחנה</option>
                    <option value="gymnastics">התעמלות</option>
