                            ...
                            return (
                              <div
                                ...
                                title={slot.is_occupied && slot.assignment 
                                  ? `${slot.assignment.study_group_name || getActivityTypeText(slot.assignment.activity_type)} (${slot.assignment.start_time}-${slot.assignment.end_time})`
                                  : `פנוי - ${timeSlot}`
                                }
                              >
                                {slot.is_occupied && slot.assignment ? (
                                  <div className="truncate">
                                    {slot.assignment.study_group_name || getActivityTypeText(slot.assignment.activity_type)}
