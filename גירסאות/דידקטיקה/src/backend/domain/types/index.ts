...
export type AssignableType = 'homeroom' | 'study_group' | 'meeting' | 'event' | 'PE' | 'didactics' | 'exam_makeup';
export type ActivityType = 'didactics' | 'exam_makeup' | 'discussion' | 'topics' | 'insights' | 'camp_prep' | 'tracks' | 'personal_meeting' | 'event' | 'study_group' | 'homeroom' | 'PE';
