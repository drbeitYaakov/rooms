...
export default function RoomsPage() {
      ...
      <div class="bg-white p-6 rounded-lg shadow-xl max-w-2xl w-full max-h-screen overflow-y-auto">
        ...
        <div class="mb-4">
          ...
          <select id="roomType" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <option value="REGULAR">חדר רגיל</option>
            ...
            <option value="COORDINATOR">חדר רכז</option>
            ...
            <option value="CLASSROOM_M">כיתה י"ג</option>
            <option value="CLASSROOM_N">כיתה י"ד</option>
            <option value="CLASSROOM_S">כיתה ס'</option>
            <option value="CLASSROOM_EIN">כיתה ע"</option>
            <option value="CLASSROOM_P">כיתה פ'</option>
            <option value="CLASSROOM_TZADI">כיתה צ'</option>
            <option value="CLASSROOM_KUF">כיתה ק'</option>
            <option value="CLASSROOM_RESH">כיתה ר'</option>
            <option value="CLASSROOM_SHIN">כיתה ש'</option>
            <option value="CLASSROOM_TAV">כיתה ת'</option>
            <option value="HAGBAA">חגבא</option>
            <option value="ATTIC">עלייה</option>
            <option value="ALBEK">אלבק</option>
          </select>
        </div>
  ...
  const getRoomTypeDisplay = (roomType: string) => {
    const typeMap: { [key: string]: string } = {
      ...
      'CLASSROOM_M': 'כיתה י"ג',
      'CLASSROOM_N': 'כיתה י"ד',
      'CLASSROOM_S': 'כיתה ס\'',
      'CLASSROOM_EIN': 'כיתה ע"',
      'CLASSROOM_P': 'כיתה פ\'',
      'CLASSROOM_TZADI': 'כיתה צ\'',
      'CLASSROOM_KUF': 'כיתה ק\'',
      'CLASSROOM_RESH': 'כיתה ר\'',
      'CLASSROOM_SHIN': 'כיתה ש\'',
      'CLASSROOM_TAV': 'כיתה ת\'',
      'HAGBAA': 'חגבא',
      'ATTIC': 'עלייה',
      'ALBEK': 'אלבק'
    };
