      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <section className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <h1 className="text-3xl font-bold text-slate-900">בקשת חדר חד־פעמית</h1>
          ...
          <aside className="space-y-6">
            <section className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              ...
              {suggestedRoom ? (
                <p className="mt-3 text-sm leading-6 text-slate-700">
                  לפי מספר התלמידים{formData.needsProjector ? " והצורך במקרן" : ""}, חדר מתאים יכול
                  להיות <strong>{suggestedRoom.room_number}</strong> עם קיבולת של{" "}
                  <strong>{suggestedRoom.capacity}</strong>.
                </p>
              ) : (
                <p className="mt-3 text-sm leading-6 text-slate-600">
                  לאחר מילוי פרטי הקבוצה נציג כאן התאמה ראשונית, ולחיצה על השיבוץ תריץ את הלוגיקה
                  המלאה עם כל הכללים וההתראות.
                </p>
              )}
            </section>
            ...
            <section className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              ...
              <div className="mt-3 space-y-2 text-sm leading-6 text-slate-700">
                ...
                <p>התוצאה כוללת חדר נבחר, קומה ואגף, נימוק לבחירה, התראות למשתמש וחלופות אפשריות.</p>
              </div>
            </section>
