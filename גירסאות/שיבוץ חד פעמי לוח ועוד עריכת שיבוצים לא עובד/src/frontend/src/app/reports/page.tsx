...
export default function ReportsPage() {
  ...
  const convertToCSV = (data: any): string => {
    ...
    if (data.summary && data.byType) {
      ...
      // Utilization report
      let csv = 'שם חדר,סוג,תכולה,ניצולת (%)\n';
      ...
      // Conflicts report
      let csv = 'חדר,תאריך,טווח זמן,סוג 1,סוג 2\n';
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-lg text-gray-600">טוען דוחות...</div>
      </div>
    );
  }
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4">📊 דוח ניצולת חדרים</h2>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">ניצולת ממוצעת</span>
                ...
                <div className="text-sm text-gray-600">
                  <div>חדרים פעילים: {utilizationData?.summary.activeRooms || 0} / {utilizationData?.summary.totalRooms || 0}</div>
                </div>
                <button 
            ...
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4">⚠️ דוח קונפליקטים</h2>
              <div className="space-y-4">
                <div className="text-center text-gray-500">
                  <div className="text-4xl mb-2">{conflictsData?.totalConflicts || 0}</div>
                  <p className="text-sm">קונפליקטים פעילים היום</p>
                </div>
            ...
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4">📈 סטטיסטיקות שיבוץ</h2>
              <div className="space-y-3 mb-4">
                <div className="flex justify-between">
                  <span className="text-sm text-gray-600">סה"כ שיבוצים</span>
                  <span className="font-medium">{statisticsData?.summary.totalAssignments || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-600">הקבצות</span>
                  <span className="font-medium">{statisticsData?.summary.totalStudyGroups || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-600">שיעורים רגילים</span>
              ...
              {/* Simple Bar Chart */}
              <div className="mt-4">
                <h3 className="text-sm font-medium text-gray-700 mb-2">חלוקת שיבוצים לפי סוג</h3>
            ...
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4">📅 יצוא דוחות</h2>
              <div className="space-y-3">
                <div>
                  <h3 className="text-sm font-medium text-gray-700 mb-2">דוח סטטיסטיקה</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-700 mb-2">דוח ניצולת</h3>
                  <div className="flex gap-2">
                    <button 
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-700 mb-2">דוח קונפליקטים</h3>
                  <div className="flex gap-2">
                    <button 
            ...
            <div className="bg-white shadow rounded-lg p-6 lg:col-span-2">
              <h2 className="text-lg font-medium text-gray-900 mb-4">📊 מגמות יומיות</h2>
              <div className="space-y-2">
                {statisticsData?.daily.slice(0, 7).reverse().map((day, index) => {
                  ...
                  return (
                    <div key={day.date} className="flex items-center">
                      ...
                      <span className="text-xs text-gray-500 w-8 text-left">{day.roomsUsed} חדרים</span>
                    </div>
                  );
                })}
              </div>
