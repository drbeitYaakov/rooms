...
export type AssignableType = 'homeroom' | 'study_group' | 'event' | 'PE' | 'didactics' | 'exam_makeup' | 'one_on_one' | 'discussion_topics' | 'high_school_pe' | 'room_block';
export type ActivityType = 'didactics' | 'exam_makeup' | 'discussion' | 'topics' | 'insights' | 'camp_prep' | 'tracks' | 'personal_meeting' | 'one_on_one' | 'event' | 'study_group' | 'homeroom' | 'PE' | 'high_school_pe' | 'music_room_block';
