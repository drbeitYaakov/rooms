  ...
  return (
    ...
    >
      <div className="w-full max-w-xl rounded-[28px] border border-rose-100 bg-white p-8 text-right shadow-[0_24px_80px_-32px_rgba(15,23,42,0.28)]">
        ...
        <h1 className="mt-4 text-3xl font-bold text-slate-900">משהו השתבש במסך הזה</h1>
        <p className="mt-3 text-sm leading-6 text-slate-600">
          המערכת נתקלה בתקלה לא צפויה. אפשר לנסות לטעון מחדש את המסך, ואם הבעיה חוזרת לעבור לעמוד אחר ולחזור שוב.
        </p>
