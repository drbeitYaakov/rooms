...
const REMINDERS: ReminderItem[] = [
  ...
  {
    id: "fixed-hours",
    title: "הגדרת שעות קבועות לכיתות האם",
    description: "אחרי שיבוץ כיתות האם כדאי לעבור על השעות הקבועות שלהן ולעדכן את מסגרות הזמן הקבועות לשנה החדשה.",
    href: "/homerooms?tab=fixed-times",
    cta: "לעדכון שעות קבועות",
  },
  {
    id: "study-groups",
